          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-primary">
                Plataforma Educacional de Nova Geração
              </span>
            </motion.div>
            ...
            >
              ...
              <span className="relative">
                <span className="relative z-10">
                  simuladores visuais interativos
                </span>
                <motion.span
            ...
            >
              ...
              >
                <Button
                  size="lg"
                  asChild
                  className="bg-gradient-to-r from-os-primary to-os-secondary text-white shadow-lg shadow-os-primary/50 hover:shadow-xl hover:shadow-os-primary/50 transition-all"
                >
                  <Link href="/os">
              ...
              >
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="border-2 backdrop-blur-sm text-white"
                >
                  <Link href="/os/memoria/paginacao">
                    <Play className="mr-2 size-5 text-white" />
                    Ver Demonstração
                  </Link>
                </Button>
              </motion.div>
        ...
        <section className="container mx-auto px-4 py-20">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Combinamos teoria acadêmica com tecnologia de ponta para criar a
                ...
                <Card className="group relative overflow-hidden p-8 h-full bg-gradient-to-br from-os-primary/10 to-os-secondary/10 border-2 border-os-primary/20 hover:border-os-primary/50 transition-all hover:shadow-2xl hover:shadow-os-primary/20">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-muted-foreground mb-6">
                      Explore processos, threads, gerenciamento de memória,
                      paginação, segmentação e muito mais através de simuladores
                      interativos 2D e 3D.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {[
                        ...
                        <Badge
                          key={topic}
                          variant="secondary"
                          className="bg-os-primary/20 text-os-primary"
                        >
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
                Junte-se a milhares de estudantes que já estão dominando
                conceitos complexos de forma visual e interativa
              </p>
              ...
              >
                <Button
                  size="lg"
                  asChild
                  className="bg-white text-os-primary hover:bg-white/90 shadow-2xl shadow-black/20"
                >
                  <Link href="/os">
                    <Cpu className="mr-2 size-5" />
